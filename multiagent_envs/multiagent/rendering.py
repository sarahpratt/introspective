...
class Viewer(object):
    ...
    def render(self, return_rgb_array=False):
        ...
        self.geoms.append(self.draw_circle(pargs.region_area, 100, filled=False))
        # self.geoms.append(Line(start=(-1.0, -1.0), end=(1.0, -1.0), width=5))
        # self.geoms.append(Line(start=(-1.0, -1.0), end=(-1.0, 1.0), width=5))
        # self.geoms.append(Line(start=(-1.0, 1.0), end=(1.0, 1.0), width=5))
        # self.geoms.append(Line(start=(1.0, -1.0), end=(1.0, 1.0), width=5))
...
def make_circle(radius=10, res=30, filled=True):
    ...
    if filled:
        ...
        return PolyLine(points, True, width=3)
